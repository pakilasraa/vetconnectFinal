<x-guest-layout>
    <div class="mb-5 text-center">
        ...
        <p style="font-size:0.875rem; color:#000000;">Join VetConnect today!</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div style="display:flex; flex-direction:column; gap:1rem;">
            <!-- Name -->
            <div>
                <label for="name" style="display:block; font-size:0.875rem; font-weight:600; color:#000000; margin-bottom:0.35rem;">Full Name</label>
            ...
            <!-- Password -->
            <div>
                <label for="password" style="display:block; font-size:0.875rem; font-weight:600; color:#000000; margin-bottom:0.35rem;">Password</label>
            ...
            <!-- Confirm Password -->
            <div>
                <label for="password_confirmation" style="display:block; font-size:0.875rem; font-weight:600; color:#000000; margin-bottom:0.35rem;">Confirm Password</label>
