        ...
        <div class="header-element">
          <div class="horizontal-logo">
            <a href="{{ url('/') }}" class="header-logo">
               ...
               @include('layouts.partials.valex.logo', ['class' => 'toggle-white'])
            </a>
          </div>
        </div>
        <!-- End::header-element -->
        ...
        <div class="header-element !items-center">
          ...
          <form action="{{ route('admin.search') }}" method="GET" class="main-header-center hidden lg:block">
            <input
              ...
              placeholder="Search for anything..." type="text" value="{{ request('query') }}">
            <button class="btn" type="submit"><i class="fa fa-search hidden md:block opacity-[0.5]"></i></button>
          </form>
          <!-- End::header-link -->
        </div>
      </div>
      <div class="header-content-right">
        ...
        <div class="header-element header-theme-mode hidden !items-center sm:block !py-[1rem] !px-[0.65rem]">
          ...
          <a aria-label="anchor"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" fill="currentColor" height="24"
              ...
              <path
                d="M480-360q50 0 85-35t35-85q0-50-35-85t-85-35q-50 0-85 35t-35 85q0 50 35 85t85 35Zm0 80q-83 0-141.5-58.5T280-480q0-83 58.5-141.5T480-680q83 0 141.5 58.5T680-480q0 83-58.5 141.5T480-280ZM200-440H40v-80h160v80ZM720-440H760v-80h160v80ZM440-760v-160h80v160h-80Zm0 720v-160h80v160h-80ZM256-650l-101-97 57-59 96 100-52 56Zm492 496-97-101 53-55 101 97-57 59Zm-98-550 97-101 59 57-100 96-56-52ZM154-212l101-97 55 53-97 101-59-57Zm326-268Z" />
            </svg>
          </a>
        </div>
        ...
        <div
          ...
          <div
            ...
            <div class="text-center !rounded-bl-md !rounded-br-md dropdown-footer">
              <a href="javascript:void(0);" class="text-primary text-[.8125rem]">VIEW ALL</a>
            </div>
          </div>
        </div>
            ...
            <ul class="list-none mb-0" id="header-notification-scroll">
              <li class="dropdown-item px-3">
                <div class="flex items-center">
                  ...
                  <div class="ms-auto">
                    <a href="javascript:void(0);"><i class="las la-angle-right text-end text-muted icon rtl:rotate-180"></i></a>
                  </div>
                </div>
              </li>
              <li class="dropdown-item px-3">
        ...
        <div
          ...
          <button id="dropdown-profile" type="button"
            ...
            <img class="inline-block rounded-full " src="{{ Auth::check() && Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('backend/assets/images/faces/6.jpg') }}" width="37" height="37"
              alt="{{ Auth::check() ? Auth::user()->name : 'User' }} profile photo">
          </button>
          <div
            ...
            <ul class="dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
              ...
              <li>
                <div class="main-header-profile bg-primary menu-header-content text-white">
                  <div class="my-auto">
                    <h6 class="mb-0 leading-none text-white">{{ Auth::user()->name ?? 'User' }}</h6>
                    <span class="text-[.6875rem] opacity-[0.7] leading-none">Member</span>
                  </div>
                </div>
              </li>
              <li><a class="dropdown-item text-defaulttextcolor flex " href="{{ route('profile.edit') }}"><i
