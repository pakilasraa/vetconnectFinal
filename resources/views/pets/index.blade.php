        ...
        <div class="box custom-box mt-3">
            <div class="box-header flex justify-between">
                ...
                <div class="flex items-center gap-2">
                    <form action="{{ route('pets.index') }}" method="GET" class="flex items-center">
                    ...
                    <a href="{{ route('pets.create') }}" class="ti-btn !py-1 !px-2 ti-btn-primary !font-medium !text-[0.75rem]">New
